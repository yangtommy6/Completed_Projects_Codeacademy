...
df = pd.DataFrame(df, columns= ['Number','Date','Service/Problem','MIC','Contact Attempt','Contact Reasoning','OPS Resolution','Good Comms','Twitter/notify','Root Cause','Template','Timeline','Outage','Wrap Up <30','EvaluateTime (min)','Total','Notes'])
